...
An Object Relational Mapper (ORM) is a code library that plots the transfer of data stored in a database (usually relational) into objects represented in the code.(*) If you're already familiar with ORMs, feel free to jump to the [next section](#prisma) on Prisma.
